...
class Button:
    ...
    def draw(self, surface: pygame.Surface) -> None:
        ...
        # Animation: the button moves down by 3 pixels when clicked
        ...
        # 3D edge / Shadow (visible only when the button is not clicked)
        ...
        # Very light "Reflection" effect at the top of the button to give volume
...
class Slider:
    ...
    def handle_event(self, event: pygame.event.Event) -> bool:
        if event.type == pygame.MOUSEBUTTONDOWN and event.button == 1:
            # Slightly enlarged click zone for more comfort
